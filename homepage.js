...
class Homepage extends Component {
  ...
  render() {
    const fullName = "ELMA SASKIA";
    const nim = "1203210056";
    const kampus = "Institut Teknologi Telkom Surabaya";
    const address = "Mojokerto";
      ...
      <View style={{ flex: 1}}>
        ...
        <View style={{flex: 1, backgroundColor:'#FFFFFF'}}>
            ...
            <View style={{marginLeft: 75}}>
              <View style={styles.Listsosmed}>
                ...
                <View style={styles.content}>  
                  <Text style={styles.keterangan}>081330447656</Text>
                </View>
              </View>
              <View style={styles.Listsosmed}>
                <View style={styles.iconstyles}>
          ...
          <View style={{ flexDirection: 'row', marginTop: 40, marginHorizontal: 30}}>
            ...
            onPress={() => Linking.openURL('https://instagram.com/elmasaskiaa?igshid=MmVlMjlkMTBhMg==')}
            >
              <Icon name="instagram" size={25} color="#212121" />
            </TouchableOpacity>
            <TouchableOpacity 
            style={styles.betweenicons}
            onPress={() => Linking.openURL('https://github.com/anakmudabgt/UTSPEMMOB?search=1')}
            >
